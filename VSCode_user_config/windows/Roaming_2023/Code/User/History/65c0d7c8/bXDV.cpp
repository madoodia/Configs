...
int main()
{
    ...
    std::cout << "Ancesstors of " << madoodia << std::endl;
    for (auto& element : ancesstors)
    {
        std::cout << element->name << std::endl;
    }

    People descendants;
    madoodia->getDescendants(descendants);
    std::cout << "descendants of " << madoodia << std::endl;
    ...
    std::cout << "siblings of " << madoodia << std::endl;
    ...
    std::cout << "cousins of " << madoodia << std::endl;
