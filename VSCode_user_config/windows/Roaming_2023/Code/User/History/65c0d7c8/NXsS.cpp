...
int main()
{
    ...
    Person* reza1 = new Person(Person::MALE, "Reza1");
    Person* reza2 = new Person(Person::MALE, "Reza2");
    Person* reza3 = new Person(Person::MALE, "Reza3");

    Person* artemis = new Person(Person::FEMALE, "Artemis");

    Person* shokat = new Person(Person::FEMALE, "Shokat");
    ...
    reza->addChilds(People{reza1, reza2, reza3});
    // .......................
    People ancesstors;
    ...
    People cousins;
    std::cout << "cousins of " << ryan->name << std::endl;
    ryan->getCousins(cousins);
    for (auto& element : cousins)
    {
        std::cout << element->name << std::endl;
    }
    std::cout << "----------------------" << std::endl;
