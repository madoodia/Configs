...
int main()
{
    ...
    // .......................
    People ancesstors;
    std::cout << "Ancesstors of " << madoodia->name << "\n";
    madoodia->getAncestors(ancesstors);
    std::cout << "----------------------"
              << "\n";

    // People descendants;
    // std::cout << "descendants of " << morteza->name << "\n";
    // morteza->getDescendants(descendants);
    // std::cout << "----------------------" << "\n";

    People descendants;
    std::cout << "descendants of " << heidar->name << "\n";
    heidar->getDescendants(descendants);
    std::cout << "----------------------"
              << "\n";

    People siblings;
    std::cout << "siblings of " << madoodia->name << "\n";
    madoodia->getSiblings(siblings);
    std::cout << "----------------------"
              << "\n";

    People cousins;
    std::cout << "cousins of " << madoodia->name << "\n";
