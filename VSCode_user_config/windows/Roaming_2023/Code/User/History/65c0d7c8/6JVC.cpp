...
int main()
{
    ...
    Person* kid1 = new Person(Person::MALE, "Kid1");
    Person* kid2 = new Person(Person::MALE, "Kid2");
    Person* kid3 = new Person(Person::MALE, "Kid3");
    ...
    reza->addChilds(People{kid1, kid2, kid3});
    // .......................
    People ancesstors;
