          ...
          id: mainButton
            ...
            MouseArea {
                ...
                onPressed: {
                  ...
                  mainText.color: "#F4F4F4"
                      ColorOverlay {
                          anchors.fill: iconImage
                          source: iconImage
                          color: "#F4F4F4"  // make image like it lays under red glass 
                      }
                }
                onReleased: {
                  mainButton.color: "#F4F4F4"
                  mainText.color: "#333333"
                      ColorOverlay {
                          anchors.fill: iconImage
                          source: iconImage
                          color: "#333333"  // make image like it lays under red glass 
                      }
                }
                onClicked: {
                  if(menuText === "About")
                    settingsStackView.push("qrc:/UI/SettingsScreen/AboutPage.qml")
                }
            }
