...
Item {
  ...
  function createHeatSelectDialog() {
    if (heatSelectDialogHolder === null) {
      // var component = Qt.createComponent("qrc:/UI/HomeScreen/HeatSelectDialog.qml")
      Component {id: dialogComp; HeatSelectDialog{}}
      heatSelectDialogHolder = dialogComp.createObject(homeScreen, {
                                                        "x": 0,
                                                        "y": 0
                                                      })
